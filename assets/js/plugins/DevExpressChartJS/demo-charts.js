...
$("#line-chart").dxChart({
    dataSource: [
		{ year: 1950, beğenen: 15000, pas: 1000 },
		{ year: 1960, beğenen: 10000, pas: 5000 },
		{ year: 1970, beğenen: 17000, pas: 12000 },
		{ year: 1980, beğenen: 20000, pas: 10000 },
		{ year: 1990, beğenen: 20000, pas: 20000 },
        { year: 1990, beğenen: 21000, pas: 22000 },
        { year: 1990, beğenen: 23000, pas: 25000 }
	],
    commonSeriesSettings: {
        argumentField: "year"
    },
    series: [
        { valueField: "beğenen", name: "Beğenen Sayısı", color: "#32d2c9" },
        { valueField: "pas", name: "Pas Geçen Sayısı", color: "#f8a20f" }
    ],
    tooltip:{
        enabled: true,
		font: { size: 16 }
